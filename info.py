...
API_ID = int(environ('API_ID') "7515868")) 
API_HASH = environ('API_HASH') "dbd251e9ad4883b0443cc82b618ac6fa")) 
BOT_TOKEN = environ('BOT_TOKEN') "6372507849:AAFa7dIFPtfCepncAK8PqM6uGB8khT84OY0")) 
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6081617163 1676717784').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://suresh44:suresh44@cluster0.l59cqpe.mongodb.net/?retryWrites=true&w=majority")
...
WELCOM_PIC = environ.get("WELCOM_PIC", "https://telegra.ph/file/1d17409b2d3b3f8e5b832.jpg")
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "{file_name} Uploaded By - @Telugu_Movies_999
📁File Size:")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001961888480')).split()]
